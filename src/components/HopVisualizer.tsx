...
const ServerNode = ({ location, protocol, directory }: {
  ...
  <div className="flex flex-col items-center group flex-shrink-0">
    ...
    <div className="relative">
      <div className="w-20 h-20 bg-gradient-to-br from-blue-600 via-purple-600 to-indigo-700 rounded-lg flex items-center justify-center shadow-lg border border-blue-400/30 transition-all duration-300 group-hover:scale-105 group-hover:shadow-xl group-hover:border-blue-400/50">
...
const ConnectionArrow = () => (
  <div className="flex items-center flex-shrink-0">
    <div className="w-8 h-0.5 bg-gradient-to-r from-purple-500 to-indigo-500 relative">
...
const FinalArrow = () => (
  <div className="flex items-center flex-shrink-0">
    <div className="w-8 h-0.5 bg-gradient-to-r from-indigo-500 to-green-500 relative">
      <div className="absolute -right-1 top-1/2 transform -translate-y-1/2 w-0 h-0" 
           style={{ 
...
const DeviceIcon = ({ type, label }: { type: 'user' | 'internet'; label: string }) => (
  <div className="flex flex-col items-center flex-shrink-0">
    <div className={`w-10 h-10 bg-gradient-to-br ${type === 'user' ? 'from-gray-700 to-gray-800' : 'from-green-600 to-emerald-700'} rounded-lg flex items-center justify-center shadow-lg border ${type === 'user' ? 'border-gray-600' : 'border-green-500/30'}`}>
      <svg className={`w-4 h-4 ${type === 'user' ? 'text-gray-300' : 'text-white'}`} fill="none" stroke="currentColor" viewBox="0 0 24 24">
        {type === 'user' ? (
    ...
    <div className="max-w-7xl mx-auto px-4 py-3">
      <div className="bg-gradient-to-br from-slate-900 via-slate-800 to-slate-900 rounded-lg p-3 shadow-xl border border-slate-700">
        <div className="text-center mb-3">
          <h2 className="text-base font-bold text-white mb-1">Multi-Hop VPN Route</h2>
        ...
        <div className="relative">
          ...
          <div className="relative flex items-center justify-center space-x-3 overflow-x-auto pb-2">
